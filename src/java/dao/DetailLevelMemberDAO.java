 ...
 * @author Admin
 */
public class DetailLevelMemberDAO implements ICommon<DetailLevelMember>{
    Session ss;
    ...
    public DungChung.ReturnMessage getData() {
        ...
        try {
            ...
            Query q = ss.createQuery("from DetailLevelMember");
            List<DetailLevelMember> data = q.list();
            ss.close();
            msg.data = data;
        } catch (Exception e) {
    ...
    public DungChung.ReturnMessage getById(String id) {
        ...
        try {
            ss = HibernateUtil.getSessionFactory().openSession();
            DetailLevelMember data = (DetailLevelMember) ss.get(DetailLevelMember.class, id);
            ss.close();
            msg.data = data;
        } catch (Exception e) {
            msg.setError("Error " + e.toString());
    ...
    @Override
    public DungChung.ReturnMessage setData(DetailLevelMember entity) {
        ReturnMessage msg = new ReturnMessage(ReturnMessage.eState.SUCCESS);
        msg.setStatus();
        try {
            ss = HibernateUtil.getSessionFactory().openSession();
            ...
            if ("".equals(entity.getId())) {
                ...
                general<DetailLevelMember> c = new general<>();
    ...
    public DungChung.ReturnMessage removeData(String id) {
        ...
        try {
            ss = HibernateUtil.getSessionFactory().openSession();
            DetailLevelMember data = (DetailLevelMember) this.getById(id).data;
            ss.beginTransaction();
            ss.delete(data);
            ss.getTransaction().commit();
            ss.close();
