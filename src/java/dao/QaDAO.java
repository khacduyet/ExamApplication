 ...
 * @author Admin
 */
public class QaDAO implements ICommon<Qa>{
    Session ss;
    ...
    public DungChung.ReturnMessage getData() {
        ...
        try {
            ...
            Query q = ss.createQuery("from Qa");
            List<Qa> data = q.list();
            ss.close();
            msg.data = data;
        } catch (Exception e) {
    ...
    @Override
    public DungChung.ReturnMessage setData(Qa entity) {
        DungChung.ReturnMessage msg = new DungChung.ReturnMessage(DungChung.ReturnMessage.eState.SUCCESS);
        msg.setStatus();
        try {
            ss = HibernateUtil.getSessionFactory().openSession();
    ...
    public DungChung.ReturnMessage removeData(String id) {
        ...
        try {
            ss = HibernateUtil.getSessionFactory().openSession();
            Qa data = (Qa) this.getById(id).data;
            ss.beginTransaction();
            ss.delete(data);
            ss.getTransaction().commit();
            ss.close();
