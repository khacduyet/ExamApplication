 ...
 * @author Admin
 */
public class RoleDetailDAO implements ICommon<RoleDetail>{
    Session ss;
    ...
    public DungChung.ReturnMessage getData() {
        ...
        try {
            ...
            Query q = ss.createQuery("from RoleDetail");
            List<RoleDetail> data = q.list();
            ss.close();
            msg.data = data;
        } catch (Exception e) {
    ...
    public DungChung.ReturnMessage getById(String id) {
        ...
        try {
            ss = HibernateUtil.getSessionFactory().openSession();
            RoleDetail data = (RoleDetail) ss.get(RoleDetail.class, id);
            ss.close();
            msg.data = data;
        } catch (Exception e) {
            msg.setError("Error " + e.toString());
    ...
    @Override
    public DungChung.ReturnMessage setData(RoleDetail entity) {
        DungChung.ReturnMessage msg = new DungChung.ReturnMessage(DungChung.ReturnMessage.eState.SUCCESS);
        msg.setStatus();
        try {
            ss = HibernateUtil.getSessionFactory().openSession();
