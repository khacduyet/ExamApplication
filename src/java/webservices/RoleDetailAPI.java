...
@Stateless
@Path("/role-detail")
public class RoleDetailAPI extends BaseAPI {

    RoleDetailDAO db;

    public RoleDetailAPI() {
        db = new RoleDetailDAO();
    }
    ...
    public String insert(@Context HttpHeaders httpHeader, String entity) {
        ...
        if (cu != null) {
            ...
            if (IRole.isRole(roles, LEVEL.MEDIUM)) {
                ...
                Gson g = new Gson();
                RoleDetail p = g.fromJson(entity, RoleDetail.class);
